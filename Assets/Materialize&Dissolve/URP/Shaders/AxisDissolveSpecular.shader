	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MainTex211 = IN.ase_texcoord7.xy;
				...
				float2 uv_BumpMap220 = IN.ase_texcoord7.xy;
				float3 TangentNormal217 = UnpackNormalScale( tex2D( _BumpMap, uv_BumpMap220 ), 1.0f );
				
				float2 uv_EmissionMap226 = IN.ase_texcoord7.xy;
				...
				float2 uv_SpecGlossMap227 = IN.ase_texcoord7.xy;
				...
				float2 uv_OcclusionMap238 = IN.ase_texcoord7.xy;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_EmissionMap226 = IN.ase_texcoord2.xy;
				float4 EmissionColor233 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap226 ) * _EmissionColor ) : float4( 0,0,0,0 ) );
				float4 DissolveEmission244 = EmissionColor109_g20;
...
/*ASEBEGIN
Version=18935
200;73;1694;655;-280.1914;-379.4184;1.394775;True;False
...
ASEEND*/
//CHKSM=865472F42878DB53C9E94FA675CF747A723E3AE2