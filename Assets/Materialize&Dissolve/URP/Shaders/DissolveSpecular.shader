	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 triplanar20_g3 = TriplanarSampling20_g3( _GuideTexture, WorldPosition, WorldNormal, 1.0, temp_cast_1, 1.0, 0 );
				...
				float2 uv_SpecGlossMap156 = IN.ase_texcoord7.xy;
				...
				float2 uv_OcclusionMap166 = IN.ase_texcoord7.xy;
				float OcclusionMap170 = tex2D( _OcclusionMap, uv_OcclusionMap166 ).r;
				
				float DissolveAlpha125 = temp_output_6_0_g3;
				
				float3 Albedo = AlbedoColor158.rgb;
				float3 Normal = TangentNormal174;
				float3 Emission = ( EmissionColor164 + DissolveEmission129 ).rgb;
				float3 Specular = SpecularColor171.rgb;
				float Metallic = 0;
				float Smoothness = SmoothnessValue176;
				float Occlusion = OcclusionMap170;
				float Alpha = DissolveAlpha125;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float4 triplanar20_g3 = TriplanarSampling20_g3( _GuideTexture, WorldPosition, ase_worldNormal, 1.0, temp_cast_0, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g3 = triplanar20_g3.x;
				#else
				float staticSwitch24_g3 = tex2D( _GuideTexture, uv_GuideTexture ).r;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_MainTex153 = IN.ase_texcoord2.xy;
				float4 tex2DNode153 = tex2D( _MainTex, uv_MainTex153 );
				float4 AlbedoColor158 = ( tex2DNode153 * _Color );
				
				float2 uv_EmissionMap150 = IN.ase_texcoord2.xy;
				float4 EmissionColor164 = ( _UseEmission == 1.0 ? ( tex2D( _EmissionMap, uv_EmissionMap150 ) * _EmissionColor ) : float4( 0,0,0,0 ) );
				float2 uv_GuideTexture = IN.ase_texcoord2.xy * _GuideTexture_ST.xy + _GuideTexture_ST.zw;
				float2 temp_cast_1 = (_UVTilingTriplanar).xx;
				float3 ase_worldNormal = IN.ase_texcoord3.xyz;
				float4 triplanar20_g3 = TriplanarSampling20_g3( _GuideTexture, WorldPosition, ase_worldNormal, 1.0, temp_cast_1, 1.0, 0 );
				#ifdef _USETRIPLANAR_ON
				float staticSwitch24_g3 = triplanar20_g3.x;
				#else
				float staticSwitch24_g3 = tex2D( _GuideTexture, uv_GuideTexture ).r;
...
/*ASEBEGIN
Version=18935
200;73;1694;655;-1225.28;824.8702;1;True;False
...
Node;AmplifyShaderEditor.SamplerNode;153;1673.594,-646.7911;Inherit;True;Property;_MainTex;Albedo;1;3;[Header];[NoScaleOffset];[SingleLineTexture];Create;False;1;Main;0;0;True;1;Space;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;181;3719.971,-327.1321;Inherit;False;Constant;_Float3;Float 3;16;0;Create;True;0;0;0;False;0;False;0.5;0;0;0;0;1;FLOAT;0
...
WireConnection;129;0;184;15
WireConnection;1;0;145;0
WireConnection;1;1;148;0
WireConnection;1;2;147;0
WireConnection;1;9;142;0
WireConnection;1;4;141;0
WireConnection;1;5;144;0
WireConnection;1;6;132;0
WireConnection;1;7;181;0
ASEEND*/
//CHKSM=7E130590B485096D1D750DF2F8F4DAE23E424095